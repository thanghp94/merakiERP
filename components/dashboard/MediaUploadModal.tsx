...
const MediaUploadModal: React.FC<MediaUploadModalProps> = ({
  ...
  const maxFileSize = 10 * 1024 * 1024; // 10MB (reduced from 100MB)
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
          ...
          <div className="mb-6">
            ...
            >
              ...
              <p className="text-sm text-gray-500">
                Supports: JPG, PNG, GIF, MP4, MOV, AVI (Max 100MB each)
              </p>
            </div>
                ...
                {selectedFiles.map((mediaFile, index) => (
                  <div key={index} className="relative group">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-black bg-opacity-70 text-white p-2 text-xs">
                      ...
                      <p>{(mediaFile.file.size / 1024 / 1024).toFixed(1)} MB</p>
                    </div>
        ...
        <div className="bg-gray-50 px-6 py-4 flex items-center justify-between">
          <div className="text-sm text-gray-500">
            Files will be organized in Google Drive by class and session
          </div>
